...
class Uwuifier {
    ...
    uwuifyWords(sentence) {
        ...
        const uwuifiedSentence = words.map((word) => {
            if ((0, utils_js_1.isAt)(word))
                return word;
            if ((0, utils_js_1.isUri)(word))
                return word;
            const seed = new seed_js_1.default(word);
    ...
    uwuifySpaces(sentence) {
        ...
        const uwuifiedSentence = words.map((word, index) => {
            ...
            else if (random <= stutterThreshold && !(0, utils_js_1.isUri)(word)) {
            ...
            function checkCapital() {
                ...
                if ((0, utils_js_1.getCapitalPercentage)(word) > 0.5)
                    return;
...
__decorate([
    (0, utils_js_1.InitModifierParam)()
